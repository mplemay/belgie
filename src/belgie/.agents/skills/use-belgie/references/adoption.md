...
- Built with maturin + PyO3; source builds need Rust
...
Contributors building belgie from source:
...
See the repository [agents.md](../../../../../../agents.md) for contributor conventions.
