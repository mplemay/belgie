...
class TestBelgieErrors:
    def test_exception_hierarchy_is_directly_exported_from_core(self) -> None:
    ...
    def test_core_exception_classes_use_public_error_module(self, error_type: type[BelgieError]) -> None:
        assert error_type.__module__ == "belgie.errors"

    def test_core_errors_are_identical_to_public_errors(self) -> None:
