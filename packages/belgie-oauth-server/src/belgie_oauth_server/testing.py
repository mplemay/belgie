...
if TYPE_CHECKING:
    ...
    from belgie_proto.oauth_server import OAuthServerClientUpdates
...
class InMemoryOAuthServerAdapter(
    ...
    @classmethod
    def _touch[T: _TimestampedRecord](cls, instance: T) -> T:
        instance.updated_at = cls._now()
        return instance
