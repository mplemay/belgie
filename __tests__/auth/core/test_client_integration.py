...
def app(auth: Auth) -> FastAPI:
    """FastAPI app with test endpoints using AuthClient."""
    app = FastAPI()
...
@pytest.fixture
def make_request_with_cookie(auth_settings: AuthSettings):
...
class TestGetUser:
    """Tests for AuthClient.get_user() method."""
...
class TestGetSession:
    """Tests for AuthClient.get_session() method."""
...
class TestDeleteUser:
    """Tests for AuthClient.delete_user() method."""
...
class TestGetUserFromSession:
    """Tests for AuthClient.get_user_from_session() method."""
...
class TestSignOut:
    """Tests for AuthClient.sign_out() method."""
