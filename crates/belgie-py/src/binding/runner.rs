...
use crate::{
    ...
    convert::runner_arguments_from_py,
    executor, py_error,
};
use belgie::{
    command::CommandSource,
    runtime::{DenoExecutionHandle, RuntimeSession},
    script::ScriptSource,
    utils::cancel_guard::CancelGuard,
};
...
impl PySyncRunner {
    ...
    fn __call__(
        ...
        executor::execute_sync(py, &self.handle, runner_arguments_from_py(args, kwargs)?)
    }
...
impl PyAsyncRunner {
    ...
    fn __call__<'py>(
        ...
        let arguments = runner_arguments_from_py(args, kwargs)?;
