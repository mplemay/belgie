...
impl RunSignature {
    pub fn overflow_param(&self) -> Option<usize> {
...
pub fn parse_script_module(content: &str, media_type: MediaType) -> Option<deno_ast::ParsedSource> {
...
pub fn run_signature_from_parsed(parsed: &deno_ast::ParsedSource) -> Option<RunSignature> {
