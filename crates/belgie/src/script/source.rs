...
impl ScriptSource {
    pub fn from_options(options: ScriptOptions) -> Self {
    ...
    pub fn media_type(&self) -> deno_ast::MediaType {
        self.media_type
    }

    pub fn execution_content(&self) -> String {
    ...
    pub fn needs_package_loader(&self) -> bool {
        self.needs_package_loader
    }

    pub fn run_signature(&self) -> Option<&RunSignature> {
