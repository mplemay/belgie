...
#[derive(Clone, Debug, Default)]
pub enum RuntimePermissionOptions {
    #[default]
    AllowAll,
    None {
        prompt: bool,
...
impl RuntimeOptions {
    ...
    pub fn new_with_js_runtime_options(
        cwd: PathBuf,
        js_runtime: JsRuntimeOptions,
        environment: Option<RuntimeEnvironment>,
    ) -> Self {
    ...
    pub fn js_runtime(&self) -> &JsRuntimeOptions {
        &self.js_runtime
    }

    pub fn worker(&self) -> &RuntimeWorkerOptions {
        &self.worker
    }

    pub fn environment(&self) -> Option<&RuntimeEnvironment> {
        self.environment.as_ref()
    }
}

impl RuntimeEnvironment {
    pub fn isolated(&self) -> Option<&SharedEnvironment> {
        match self {
...
impl RuntimeWorkerOptions {
    ...
    pub fn requires_package_worker(&self) -> bool {
    ...
    pub fn permissions_container(&self) -> Result<PermissionsContainer, String> {
    ...
    pub fn location(&self) -> Option<url::Url> {
        self.location.clone()
    }

    pub fn log_level(&self) -> Option<WorkerLogLevel> {
        self.log_level
    }
    ...
    pub fn disable_offscreen_canvas(&self) -> bool {
        self.disable_offscreen_canvas
    }
...
impl RuntimePermissionOptions {
    ...
    pub fn configured(options: PermissionsOptions) -> Self {
        Self::Configured(Box::new(options))
    }

    pub fn to_permissions(&self) -> Result<Permissions, String> {
        match self {
...
impl JsRuntimeOptions {
    ...
    pub fn to_create_params(&self) -> Result<Option<deno_core::v8::CreateParams>, String> {
    ...
    pub fn max_old_generation_size_mb(&self) -> Option<u64> {
        self.max_old_generation_size_mb
    }

    pub fn max_young_generation_size_mb(&self) -> Option<u64> {
        self.max_young_generation_size_mb
    }

    pub fn code_range_size_mb(&self) -> Option<u64> {
