...
impl EnvironmentOptions {
    ...
    pub fn node_modules_dir(&self) -> Option<NodeModulesDirMode> {
        self.node_modules_dir
    }

    pub fn node_modules_linker(&self) -> Option<NodeModulesLinkerMode> {
        self.node_modules_linker
    }

    pub fn npm_caching(&self) -> NpmCachingStrategy {
        self.npm_caching
    }
    ...
    pub fn clean_on_install(&self) -> bool {
    ...
    pub fn import_package_lockfile(&self) -> bool {
        self.import_package_lockfile
    }

    pub fn minimum_dependency_age_minutes(&self) -> Option<u64> {
        self.minimum_dependency_age_minutes
    }

    pub fn minimum_dependency_age(&self) -> Option<&str> {
        self.minimum_dependency_age.as_deref()
    }

    pub fn newest_dependency_date(&self) -> Result<Option<NewestDependencyDate>, AnyError> {
